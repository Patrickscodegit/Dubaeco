<section class="relative h-72 bg-laravel flex flex-col justify-center align-center text-center space-y-4 mb-4">
  ...
  <div class="z-10">
    ...
    <div>
      ...
      @else
      <a href="/dealer"
        class="inline-block border-2 border-white text-white py-2 px-4 rounded-xl uppercase mt-2 hover:text-black hover:border-black">Become an approved partner</a>
      @endauth
    </div>
  </div>
</section>
